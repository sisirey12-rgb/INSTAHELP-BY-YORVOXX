...
def show_intro():
    ...
    print("╠════════════════════════════════════════════════════════════╣")
    print("║ 👤 Name       : YOR-VOXX                       ║")
    print("║ 🌐 Telegram Channel : https://t.me/yorxvox                          ║")
    print("║ 🅾 Instagram Id  : @sisirey.vox                           ║")
...
def show_banner():
    ...
    print("""\033[95m
╔══════════════════════════════════════════════════════════╗
║         ☠️ YOR-VOXX DDOS v5 – WORLD BREAKER ☠️               ║
║  🔥 Coded by: YOR-VOXX | Proxy + Multi-Vector Engine 🔥    ║
╠══════════════════════════════════════════════════════════╣
║  🚀 Max Threads   : {:>8}                               ║
║  ⏱️  Attack Time   : 35 seconds                            ║
...
def start_ui():
    ...
    print("\033[96m")
    print("╔════════════════════════════════════════════╗")
    print("║        🔥 YOR-VOXX DDOS TOOLKIT UI MENU 🔥      ║")
    print("╠════════════════════════════════════════════╣")
